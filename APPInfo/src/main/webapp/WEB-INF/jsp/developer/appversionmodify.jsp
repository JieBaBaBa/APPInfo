...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP版本信息 <i class="fa fa-user"></i><small>${devUserSession.devName}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
        ...
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/appVersion/addversionsave" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="versionNo" class="form-control col-md-7 col-xs-12" 
               data-validate-length-range="20" data-validate-words="1" name="versionNo"  readOnly="readonly"
               placeholder="请输入版本号" type="text"  required="required" value="${appVersion.versionNo}">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="versionSize" name="versionSize"  required="required" value="${appVersion.versionSize}"
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ${appVersion.apkFileName}&nbsp;&nbsp;<a class="collapse-link" href="#">下载</a>&nbsp;&nbsp;<a class="collapse-link" href="#">删除</a>
            ${fileUploadError }
            </div>
          </div>
