        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${pageContext.request.contextPath }/backend/main.html" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/backend/logout.html">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/backend/logout.html"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
